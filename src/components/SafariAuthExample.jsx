// Example Component Showing Safari-Compatible Authentication
// This demonstrates the proper way to handle auth in iOS Safari

import React, { useState } from 'react';
import useSafariAuth from '@/hooks/useSafariAuth';

const SafariAuthExample = () => {
  const { 
    user, 
    isLoggedIn, 
    isLoading, 
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-center">Safari-Compatible Auth</h2>
      ...
      <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded">
        <h4 className="font-semibold text-yellow-800">Safari Compatibility</h4>
        <ul className="mt-2 text-sm text-yellow-700 list-disc pl-5 space-y-1">
          <li>Uses <code className="bg-yellow-100 px-1 rounded">withCredentials: true</code> for all requests</li>
          <li>Sets cookies with <code className="bg-yellow-100 px-1 rounded">SameSite=None; Secure</code></li>
...
export default SafariAuthExample;